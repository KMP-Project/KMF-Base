...
NDefines.NResistance.INITIAL_STATE_COMPLIANCE = 5.0
NDefines.NResistance.RESISTANCE_TARGET_MODIFIER_IS_AT_PEACE = -10.0
NDefines.NResistance.RESISTANCE_TARGET_MODIFIER_OCCUPIED_CAPITULATED = 5.0
...
--AIが師団を変更
NDefines.NAI.DIVISION_UPGRADE_MIN_XP = 1
NDefines.NAI.DIVISION_CREATE_MIN_XP = 1
